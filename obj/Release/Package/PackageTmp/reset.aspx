<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reset.aspx.cs" Inherits="FinalYearProjectMasterPage.reset" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ILearn | Forgot Password?</title>
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                        ...
                        <section class="panel bg-white no-b">
                            <div class="p15">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="Msg2" runat="server" class="alert alert-success alert-dismissable" style="display: none">
                                            ...
                                            <ul>
                                                <li>We've just sent you an email about resetting your password.</li>
                                            </ul>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                                ...
                                <br />
                                <div class="actions">
                                    <asp:Button ID="Button1" runat="server" Text="Send" class="btn btn-primary btn-lg btn-block" Style="height: 55px" OnClick="Button1_Click" data-disable-with="Loading..."/>
                                </div>
                                <div class="mt5">
                                    <a style="color: #9B9B9B;" href="signin.aspx">Already a member? Sign in</a>
                                </div>
                            </div>
                        </section>
                        <p class="text-center">
