<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="PrepareLGame.aspx.cs" Inherits="FinalYearProjectMasterPage.ViewAStu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bar" runat="server">
    ...
    <li class="active">
        <a href="PrepareLGame.aspx">Create Game PIN
        </a></li>
</asp:Content>
