<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="EditQ.aspx.cs" Inherits="FinalYearProjectMasterPage.EditQ" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
     ILearn - Edit Question
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bar" runat="server">
    ...
    <li class="active">
        <a href="EditQ.aspx">Edit Question
        </a></li>
</asp:Content>
