...
{
    public partial class ViewAStu : System.Web.UI.Page
    {
        string nID = "";
        string old = "";
        int sub = 0;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            String id = (string)(Session["id"]);
            String quizid = (string)(Session["selected"]);
            bool pss = true;
            //Generated code
            Random n = new Random();
            ...
            if (pss)
            {
                ...
                Attendance attendance = db.Attendances.Single(le => le.AttID == id);
                attendance.sTime = TimeSpan.Parse(txtstime.Text);
                attendance.eTime = TimeSpan.Parse(txtetime.Text);
